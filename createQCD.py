...
hdata_taupt_SS = fdata.Get('tau_pt_SS').Clone()
hdata_taupt_QCD = fdata.Get('tau_pt_QCD').Clone()
hdata_elpt_SS = fdata.Get('el_pt_SS').Clone()
hdata_elpt_QCD = fdata.Get('el_pt_QCD').Clone()
hdata_msv_SS = fdata.Get('msv_SS').Clone()
hdata_msv_QCD = fdata.Get('msv_QCD').Clone()

hbkg_taupt_SS = hdata_taupt_SS.Clone()
hbkg_taupt_QCD = hdata_taupt_QCD.Clone()
hbkg_elpt_SS = hdata_elpt_SS.Clone()
hbkg_elpt_QCD = hdata_elpt_QCD.Clone()
...
for ifile in filelist:
    ...
    hbkg_taupt_SS.Add(ftemp.Get('tau_pt_SS'))
    hbkg_taupt_QCD.Add(ftemp.Get('tau_pt_QCD'))
    hbkg_elpt_SS.Add(ftemp.Get('el_pt_SS'))
    hbkg_elpt_QCD.Add(ftemp.Get('el_pt_QCD'))
    hbkg_msv_SS.Add(ftemp.Get('msv_SS'))
    hbkg_msv_QCD.Add(ftemp.Get('msv_QCD'))
...
hdata_elpt_SS.Add(hbkg_elpt_SS, -1)
hdata_elpt_QCD.Add(hbkg_elpt_QCD, -1)
...
hdata_taupt_QCD.Scale(hdata_taupt_SS.Integral()/hdata_taupt_QCD.Integral())
hdata_elpt_QCD.Scale(hdata_elpt_SS.Integral()/hdata_elpt_QCD.Integral())
hdata_msv_QCD.Scale(hdata_msv_SS.Integral()/hdata_msv_QCD.Integral())

hdata_taupt_QCD.SetName('tau_pt')
hdata_elpt_QCD.SetName('el_pt')
hdata_msv_QCD.SetName('msv')

hdata_taupt_QCD.Write()
hdata_elpt_QCD.Write()
hdata_msv_QCD.Write()
