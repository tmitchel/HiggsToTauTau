...
std::map<int, double> powheg_xsec{{200, 273.952}, {201, 291.030}, {202, 1317.635}, {203, 36.095},  {204, 55.776}, {205, 178.171}, {206, 18.839},
                                  {207, 37.952},  {208, 291.846}, {209, 146.782},  {210, 385.566}, {211, 64.859}, {212, 197.414}, {213, 53.598},
                                  {214, 182.107}, {215, 41.167},  {216, 187.823},  {217, 19.968},  {218, 21.092}, {219, 12.496},  {220, 18.215},
                                  {221, 13.490},  {222, 22.044},  {223, 14.220},   {224, 31.565}};
...
void print_bigtable(bool relative = true) {
    ...
    std::cout << " BIN: " << std::setw(8) << "Yield    | " << std::setw(8) << "PTH200   | " << std::setw(8) << "Mjj60    | " << std::setw(8)
              << "Mjj120   | " << std::setw(8) << "Mjj350   | " << std::setw(8) << "Mjj700   | " << std::setw(8) << "Mjj1000  | " << std::setw(8)
              << "Mjj1500  | " << std::setw(8) << "PTH25    | " << std::setw(8) << "JET01    | " << std::setw(8) << "TOT        " << std::endl;
...
double _cov(int ibin, int jbin) {
    ...
    for (int is = 0; is < uncert_deltas.size(); ++is)
        cov_ij += (vbf_uncert_stage_1_1(is, ibin) - 1) * (vbf_uncert_stage_1_1(is, jbin) - 1) * powheg_xsec[ibin] * powheg_xsec[jbin];
    return cov_ij;
}
