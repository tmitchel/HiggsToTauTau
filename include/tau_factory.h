...
private:
  std::string name = "tau";
  Int_t gen_match;
  Float_t pt, eta, phi, mass, charge, px, py, pz, dmf, dmf_new, tightIsoMVA, l2_decayMode;
...
private:
  Int_t gen_match_2;
  Float_t px_2, py_2, pz_2, pt_2, eta_2, phi_2, m_2, e_2, iso_2, q_2, mt_2, decayModeFinding_2, decayModeFindingNewDMs_2;
...
tau_factory::tau_factory(TTree* input) {
  ...
  input -> SetBranchAddress( "decayModeFindingNewDMs_2",                &decayModeFindingNewDMs_2               );
