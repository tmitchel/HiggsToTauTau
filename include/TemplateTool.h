...
void TemplateTool::make_extension_map(std::string channel_prefix) {
  extension_map = {
      {channel_prefix + "_tree_UncMet_Up", "_CMS_scale_met_unclustered_13TeVUp"},
      {channel_prefix + "_tree_UncMet_Down", "_CMS_scale_met_unclustered_13TeVDown"},
      {channel_prefix + "_tree_ClusteredMet_Up", "_CMS_scale_met_clustered_13TeVUp"},
      {channel_prefix + "_tree_ClusteredMet_Down", "_CMS_scale_met_clustered_13TeVDown"},
      {channel_prefix + "_tree_vbfMass_JetTotalUp", "_CMS_scale_jm_13TeVUp"},
      {channel_prefix + "_tree_jetVeto30_JetTotalUp", "_CMS_scale_jn_13TeVUp"},
      {channel_prefix + "_tree_vbfMass_JetTotalDown", "_CMS_scale_jm_13TeVDown"},
      {channel_prefix + "_tree_jetVeto30_JetTotalDown", "_CMS_scale_jn_13TeVDown"},
      {channel_prefix + "_tree_ttbarShape_Up", "_CMS_htt_ttbarShape_13TeVUp"},
      {channel_prefix + "_tree_ttbarShape_Down", "_CMS_htt_ttbarShape_13TeVDown"},
      {channel_prefix + "_tree_Up", "_CMS_scale_t_allprong_13TeVUp"},
      {channel_prefix + "_tree_Down", "_CMS_scale_t_allprong_13TeVDown"},
      {channel_prefix + "_tree_DM0_Up", "_CMS_scale_t_1prong_13TeVUp"},
      {channel_prefix + "_tree_DM0_Down", "_CMS_scale_t_1prong_13TeVDown"},
      {channel_prefix + "_tree_DM1_Up", "_CMS_scale_t_1prong1pizero_13TeVUp"},
      {channel_prefix + "_tree_DM1_Down", "_CMS_scale_t_1prong1pizero_13TeVDown"},
      {channel_prefix + "_tree_DM10_Up", "_CMS_scale_t_3prong_13TeVUp"},
      {channel_prefix + "_tree_DM10_Down", "_CMS_scale_t_3prong_13TeVDown"},
      {channel_prefix + "_tree_jetToTauFake_Up", "_CMS_htt_jetToTauFake_13TeVUp"},
      {channel_prefix + "_tree_jetToTauFake_Down", "_CMS_htt_jetToTauFake_13TeVDown"},
      {channel_prefix + "_tree_dyShape_Up", "_CMS_htt_dyShape_13TeVUp"},
      {channel_prefix + "_tree_dyShape_Down", "_CMS_htt_dyShape_13TeVDown"},
      {channel_prefix + "_tree_zmumuShape_Up", "_CMS_htt_zmumuShape_VBF_13TeVUp"},
      {channel_prefix + "_tree_zmumuShape_Down", "_CMS_htt_zmumuShape_VBF_13TeVDown"}};
}
