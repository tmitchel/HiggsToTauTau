...
TemplateTool::TemplateTool(std::string channel_prefix, std::string year, std::string suffix, std::shared_ptr<TFile> output_file)
    : fout(output_file),
      ...
      categories{channel_prefix + "_inclusive",         channel_prefix + "_0jet",
                 ...
                 channel_prefix + "_vbf_ggHMELA_bin1",  channel_prefix + "_vbf_ggHMELA_bin2",
                 channel_prefix + "_vbf_ggHMELA_bin3",  channel_prefix + "_vbf_ggHMELA_bin4",
                 channel_prefix + "_vbf_ggHMELA_bin5",  channel_prefix + "_vbf_ggHMELA_bin6",
                 channel_prefix + "_vbf_ggHMELA_bin7",  channel_prefix + "_vbf_ggHMELA_bin8",
                 channel_prefix + "_vbf_ggHMELA_bin9",  channel_prefix + "_vbf_ggHMELA_bin10",
                 channel_prefix + "_vbf_ggHMELA_bin11", channel_prefix + "_vbf_ggHMELA_bin12"},
      systematics{"ff_qcd_syst_up",
                  "ff_qcd_syst_down",
                  "ff_qcd_dm0_njet0_stat_up",
                  "ff_qcd_dm0_njet0_stat_down",
                  "ff_qcd_dm0_njet1_stat_up",
                  "ff_qcd_dm0_njet1_stat_down",
                  "ff_qcd_dm1_njet0_stat_up",
                  "ff_qcd_dm1_njet0_stat_down",
                  "ff_qcd_dm1_njet1_stat_up",
                  "ff_qcd_dm1_njet1_stat_down",
                  "ff_w_syst_up",
                  "ff_w_syst_down",
                  "ff_w_dm0_njet0_stat_up",
                  "ff_w_dm0_njet0_stat_down",
                  "ff_w_dm0_njet1_stat_up",
                  "ff_w_dm0_njet1_stat_down",
                  "ff_w_dm1_njet0_stat_up",
                  "ff_w_dm1_njet0_stat_down",
                  "ff_w_dm1_njet1_stat_up",
                  "ff_w_dm1_njet1_stat_down",
                  "ff_tt_syst_up",
                  "ff_tt_syst_down",
                  "ff_tt_dm0_njet0_stat_up",
                  "ff_tt_dm0_njet0_stat_down",
                  "ff_tt_dm0_njet1_stat_up",
                  "ff_tt_dm0_njet1_stat_down",
                  "ff_tt_dm1_njet0_stat_up",
                  "ff_tt_dm1_njet0_stat_down",
                  "ff_tt_dm1_njet1_stat_up",
                  "ff_tt_dm1_njet1_stat_down"} {
    // get FakeFactor workspace
    TFile *ff_file;
    if (year == "2017") {
        ff_file = new TFile(
            ("${CMSSW_BASE}/src/HTTutilities/Jet2TauFakes/data2017/SM2017/tight/vloose/" + channel_prefix + "/fakeFactors.root").c_str(), "READ");
    } else if (year == "2016") {
        ff_file = new TFile(
            ("${CMSSW_BASE}/src/HTTutilities/Jet2TauFakes/data2016/SM2016_ML/tight/" + channel_prefix + "/fakeFactors_tight.root").c_str(), "READ");
    } else if (year == "2018") {
        // data2018/SM2018/tight/vloose/mt/fakeFactors.root
        ff_file = new TFile(
            ("${CMSSW_BASE}/src/HTTutilities/Jet2TauFakes/data2018/SM2018/tight/vloose/" + channel_prefix + "/fakeFactors.root").c_str(), "READ");
    } else {
...
void TemplateTool::make_extension_map(std::string channel_prefix) {
    extension_map = {{channel_prefix + "au_tree_UncMet_Up", "_CMS_scale_met_unclustered_13TeVUp"},
...
std::string TemplateTool::get_extension(std::string name) { return extension_map.at(name); }
      ...
      acNameMap{{"ggh",
                ...
                {"wh",
                 {std::make_pair("wt_wh_a1", "reweighted_WH_htt_0PM125"), std::make_pair("wt_wh_a2", "reweighted_WH_htt_0PH125"),
                  ...
                  std::make_pair("wt_wh_a3int", "reweighted_WH_htt_0Mf05ph0125"), std::make_pair("wt_wh_L1", "reweighted_WH_htt_0L1125"),
                  std::make_pair("wt_wh_L1int", "reweighted_WH_htt_0L1f05ph0125"), std::make_pair("wt_wh_L1Zg", "reweighted_WH_htt_0L1Zg125"),
                  std::make_pair("wt_wh_L1Zgint", "reweighted_WH_htt_0L1Zgf05ph0125")}},
                {"zh",
                 {std::make_pair("wt_zh_a1", "reweighted_ZH_htt_0PM125"), std::make_pair("wt_zh_a2", "reweighted_ZH_htt_0PH125"),
                  std::make_pair("wt_zh_a2int", "reweighted_ZH_htt_0PHf05ph0125"), std::make_pair("wt_zh_a3", "reweighted_ZH_htt_0M125"),
                  std::make_pair("wt_zh_a3int", "reweighted_ZH_htt_0Mf05ph0125"), std::make_pair("wt_zh_L1", "reweighted_ZH_htt_0L1125"),
                  std::make_pair("wt_zh_L1int", "reweighted_ZH_htt_0L1f05ph0125"), std::make_pair("wt_zh_L1Zg", "reweighted_ZH_htt_0L1Zg125"),
