...
void TemplateTool::make_extension_map(std::string channel_prefix) {
  extension_map = {
      {channel_prefix + "au_tree_UncMet_Up", "xxx"},
      {channel_prefix + "au_tree_UncMet_Down", "xxx"},
      {channel_prefix + "au_tree_ClusteredMet_Up", "xxx"},
      {channel_prefix + "au_tree_ClusteredMet_Down", "xxx"},
      {channel_prefix + "au_tree_vbfMass_JetTotalUp", "xxx"},
      {channel_prefix + "au_tree_jetVeto30_JetTotalUp", "xxx"},
      {channel_prefix + "au_tree_vbfMass_JetTotalDown", "xxx"},
      {channel_prefix + "au_tree_jetVeto30_JetTotalDown", "xxx"},
      {channel_prefix + "au_tree_ttbarShape_Up", "xxx"},
      {channel_prefix + "au_tree_ttbarShape_Down", "xxx"},
      {channel_prefix + "au_tree_Up", "xxx"},
      {channel_prefix + "au_tree_Down", "xxx"},
      {channel_prefix + "au_tree_DM0_Up", "xxx"},
      {channel_prefix + "au_tree_DM0_Down", "xxx"},
      {channel_prefix + "au_tree_DM1_Up", "xxx"},
      {channel_prefix + "au_tree_DM1_Down", "xxx"},
      {channel_prefix + "au_tree_DM10_Up", "xxx"},
      {channel_prefix + "au_tree_DM10_Down", "xxx"},
      {channel_prefix + "au_tree_jetToTauFake_Up", "xxx"},
      {channel_prefix + "au_tree_jetToTauFake_Down", "xxx"},
      {channel_prefix + "au_tree_dyShape_Up", "xxx"},
      {channel_prefix + "au_tree_dyShape_Down", "xxx"},
      {channel_prefix + "au_tree_zmumuShape_Up", "xxx"},
      {channel_prefix + "au_tree_zmumuShape_Down", "xxx"}};
}
