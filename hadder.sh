...
hadd ${2}/ggh125_JHU.root ${2}/ggh125_JHU_*
hadd ${2}/vbf125_JHU.root ${2}/vbf125_JHU_*
hadd ${2}/wh125_JHU.root ${2}/wh125_JHU_*
hadd ${2}/zh125_JHU.root ${2}/zh125_JHU_*

hadd ${2}/ggh125_madgraph.root ${2}/ggh125_madgraph_*
