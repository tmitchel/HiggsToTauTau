...
all: ac-mt-2016 ac-mt-2017 ac-mt-2018 ac-et-2016 ac-et-2017 ac-et-2018 ac-tt-2018 boost-mt-2017

test: test-ac-mt-2016 test-ac-mt-2017 test-ac-mt-2018 test-ac-et-2016 test-ac-et-2017 test-ac-et-2018 test-ac-tt-2018 test-boost-mt-2017
...
ac-mt-2017: plugins/AC/mt_analyzer2017.cc
	g++ $(OPT) plugins/AC/mt_analyzer2017.cc $(ROOT) $(CFLAGS) -o $(OBIN)/analyze2017_mt

ac-mt-2018: plugins/AC/mt_analyzer2018.cc
...
ac-et-2017: plugins/AC/et_analyzer2017.cc
	g++ $(OPT) plugins/AC/et_analyzer2017.cc $(ROOT) $(CFLAGS) -o $(OBIN)/analyze2017_et

ac-et-2018: plugins/AC/et_analyzer2018.cc
...
test-ac-mt-2017: plugins/AC/mt_analyzer2017.cc
	g++ plugins/AC/mt_analyzer2017.cc $(ROOT) $(CFLAGS) -o test

test-ac-mt-2018: plugins/AC/mt_analyzer2018.cc
...
test-ac-et-2017: plugins/AC/et_analyzer2017.cc
	g++ plugins/AC/et_analyzer2017.cc $(ROOT) $(CFLAGS) -o test

test-ac-et-2018: plugins/AC/et_analyzer2018.cc
